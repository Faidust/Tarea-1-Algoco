...
\begin{figure}[H]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{figures/tiempo_aleatorio_D7.png}
        \caption*{Tiempo de ejecución}
    \end{minipage}
    \hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{figures/memoria_aleatorio_D7.png}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{figures/tiempo_aleatorio_D1.png}
        \caption*{Tiempo de ejecución}
    \end{minipage}
    \hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{figures/memoria_aleatorio_D1.png}
        \caption*{Memoria utilizada}
    \end{minipage}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{figures/tiempo_ascendente_D7.png}
        \caption*{Tiempo de ejecución}
    \end{minipage}
    \hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{figures/memoria_ascendente_D7.png}
        \caption*{Memoria utilizada}
    \end{minipage}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{figures/tiempo_descendente_D7.png}
        \caption*{Tiempo de ejecución}
    \end{minipage}
    \hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{figures/memoria_descendente_D7.png}
        \caption*{Memoria utilizada}
    \end{minipage}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{figures/tiempo_densa_D10.png}
        \caption*{Tiempo de ejecución}
    \end{minipage}
    \hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{figures/memoria_densa_D10.png}
        \caption*{Memoria utilizada}
    \end{minipage}
